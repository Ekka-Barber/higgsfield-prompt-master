...
**Stats (as of 2026-09-24):** 17,579 prompts, 9,944 stars (growing ~60-120 prompts and ~10-20 stars per day)
...
**License:** CC BY 4.0
**Public README:** 126 curated prompts with full text (6 featured + 120 regular, capped by GitHub content-length limits); remaining 17,300+ behind private Payload CMS but **fully accessible** via youmind.com gallery pages at predictable URLs: `https://youmind.com/prompts/{any-slug}-{ID}`. GPT Image 2 prompts are at IDs ~13440–26917. See `references/gpt-image2-prompt-database.md` for scraping approach and scripts.
...
### 40. Anti-Beautification Symmetry-Breaking Checklist (new, observed in No. 52 "Authentic Everyday Person Vlog Thumbnail" by Koudai Nakahara, Sep 10 2026)
For *generating* (not editing) believable ordinary people from scratch, attack the model's idealization prior with a per-feature asymmetry checklist instead of a generic "realistic" instruction:
- **Per-feature symmetry breaking:** "Slightly vary the height, angle, thickness, and shape of the left and right eyebrows. Do not perfectly align the size, opening, and position of the left and right eyes. Do not make the bridge of the nose perfectly straight or symmetrical; add slight asymmetry to the tip and nostrils. Add natural asymmetry to the height of the corners of the mouth, thickness of the lips, and lip outline. Do not make the contours or cheek volume perfectly identical on both sides. In the vertical direction of the face, do not arrange the spacing between eyes, nose, and mouth too perfectly like the golden ratio."
- **Anti-perfection extensions:** "Avoid perfect smiles or symmetrical smiles"; leave pores, slight color unevenness, small spots or dark circles; thin natural everyday makeup (no contouring, strong highlights, heavy eye makeup); hair with "a small amount of stray hairs or natural messiness"; clothing "general, clean, everyday items" not ad-model styling.
- **Lighting realism:** "Instead of uniform lighting like a studio shoot, leave slight differences in light and shadow from natural window light or indoor lighting. Do not align posture, face angle, or shoulder height evenly."
- **Governing clause:** "Prioritize 'a very ordinary adult woman who seems to exist' rather than 'the ideal woman imagined by AI.'"
- **Named-idealization ban list closer:** "Avoid elements: perfect face, symmetrical face, beautiful model, glamorous, celebrity-like, ideal proportions, golden ratio face, flawless skin, porcelain skin, doll-like face, perfect teeth, perfectly shaped eyebrows, perfectly symmetrical eyes, sharp jawline, V-shaped face, excessive beauty retouching, fashion model look, influencer look, overly polished advertising photography."

Why it works: "realistic, natural" alone fails against the model's training bias toward idealized faces — the model *can* render asymmetry but doesn't default to it. Enumerating asymmetry per feature (brows, eyes, nose, mouth, cheeks, proportions) gives it a concrete departure checklist, and the ban list names the exact idealization archetypes to suppress. Positioning in the catalog: Face Lock preserves *existing* identity from a reference; Source-Look Preservation (#21) blocks beautification in *edits*; this technique makes *generation from scratch* produce ordinary people. Use for authentic UGC-style thumbnails, background/crowd characters, testimonial-style imagery, and anywhere the "AI ideal face" breaks believability.

Sep 18 2026 cycle note (17,504 prompts): +10 prompts, +3 stars (9,902→9,905, no milestone — next: 10k). 2 new bot commits (both `[skip ci]` noise). Featured prompts unchanged (same 6). 3 entries published Sep 17 rotated into the README window — all read in full and mapped onto existing catalog, NO new technique promoted: No. 1 "Cinematic Denim Jacket Portrait" (Zorvia, Sep 17) = full labeled-section cinematic portrait paragraph (Pose/Background/Lighting/Photography style/Composition sections, 85mm f/1.8 spec) ending in a defect-list "Negative prompt:" tail — the #22 element-scoped-negative formula imported from Midjourney habit; the negative block is folklore (GPT Image 2 has no negative prompts — describe the positive state); noted not promoted; No. 21 "Woman Catching Water Spray in Rose Garden" (One Breath｜AI Portrait, Sep 17) = flat golden-hour candid paragraph with wet-hair/suspended-droplet texture cues — standard flat-photography family; No. 89 "Cinematic Portrait Prompt for GPT-Image-2" (Aijaz, Sep 17) = low-key chiaroscuro face-reference side-profile portrait (single warm light source enumerating lit facial zones, rest into deep black) — camera-spec-depth cinematic portrait, same author's recurring family. Catalog stays at 40.

Sep 19 2026 cycle note (17,523 prompts): +19 prompts, +6 stars (9,905→9,911, no milestone — next: 10k). 2 new bot commits (both `[skip ci]` noise). Featured prompts unchanged (same 6). 4 entries published Sep 17–18 rotated into the README window — all read in full and mapped onto existing catalog, NO new technique promoted: No. 1 "Hyper-Realistic Cinematic Portrait with Smoke" (Wareen AI 💟, Sep 18) = reference-image character-consistency full-body portrait (locked identity trait enumeration: violet bob, freckles, hazel eyes) + colored-atmosphere background (thick orange/peach smoke) — existing #1/#22 family; No. 2 "Bookstore Reading Photo Prompt", No. 3 "Summer Kimono Garden Scene Prompt", No. 4 "Izakaya Toast Photo Prompt" (all Prompt アトリエ｜AI画像プロンプト, Sep 17–18, JA) = same author's labeled-section formula (Subject / Main Subject / Person & Expression / Clothing & Pose / Background & Light / Composition & Camera / Texture & Style) with a "Negative:" defect-guard tail — the #22 element-scoped-negative folklore pattern again (GPT Image 2 has no negative prompts); No. 2–4 confirm the author runs the identical template across scenes (bookstore daylight, yukata garden, night izakaya), reinforcing section-template transferability rather than a novel mechanism. Catalog stays at 40.

Sep 24 2026 cycle note (17,579 prompts): +10 prompts, +8 stars (9,936→9,944, no milestone — next: 10k). 2 new bot commits (both `[skip ci]` noise). Featured prompts unchanged (same 6). 4 entries published Sep 22–23 rotated into the README window — all read in full and mapped onto existing catalog, NO new technique promoted: No. 21 "AI Realism Thumbnail: Girls with Lanterns" (VideoProc AI, Sep 23) = vertical 9:16 comparison thumbnail — photoreal recreation of an impressionist painting with bold overlay text ("AI Made This Painting" / "Real") + inset of the original painting framed in gold + hand-drawn arrow pointing painting→recreation — the #34/#4 comparison family with inset-source + directional annotation arrow, noted not promoted; No. 22 "Paper Craft Reveal Poster" (Kris Kashtanova, Sep 22) = 50/50 split-frame photo-transform — top preserves the photo, bottom is realistic paper craft on textured off-white with a torn-paper hole revealing a grayscale version of the same scene, specific elements selectively re-colorized (red/magenta/yellow) against monochrome — split-frame (#17 canvas, generation-mode) + Selective Colorization (#14) recombination, the torn-paper-window reveal is a single data point of a "medium frames a window onto the same scene" flavor, noted not promoted; No. 23 "Boisterous Shrimpers Entering Pub" (Michael H. Lester, Sep 22) = horizontal artwork|black-text-panel layout (haiku as caption, exact-string pub signage, credit block, QR code) — classic two-column layout with text panel, flat illustration family; No. 24 "Man Reading by Rainy Window" (Juan José Arango E., Sep 22) = flat cinematic paragraph (rain-streaked window distorting city lights into abstract bokeh color bands, partially legible sign text) — standard flat-photography family. Catalog stays at 40 techniques.

Sep 23 2026 cycle note (17,569 prompts): +9 prompts, +4 stars (9,932→9,936, no milestone — next: 10k). 4 new bot commits (all `[skip ci]` noise). Featured prompts unchanged (same 6). 6 entries published Sep 22 rotated into the README window — all read in full and mapped onto existing catalog, NO new technique promoted: No. 1 "Cinematic Blue Backlit Portrait" (Aijaz, Sep 22) = the author's recurring flat cinematic portrait family (cyan rim light, 85mm spec, teal-blue grade — fourth consecutive-day variant); No. 21 "Sunset Photo to Crayon Art Split", No. 22 "Tuxedo Cat Photo and Line Art Diptych", No. 23 "Minimalist Plaster Galaxy Art", No. 24 "Dolomites Lake Photo to Minimalist Art" (all 小小东, Sep 22) = four variants of one vertical diptych formula — photoreal scene on top, same scene reinterpreted below (crayon/pastel, ink line-art, white plaster sculpture, screen-print graphic) with multilingual exact-string typography (Japanese, English, Arabic, Chinese — the Arabic 'بين النجوم' poster is a single data point of Arabic display typography, noted); generation-mode split-frame (no uploaded reference) = the #17 Split-Frame family's canvas without its transform contract, same as Sep 20–21 split-panel entries; No. 90 "Editorial Food Poster" (Mira, Sep 22) = flat editorial poster with #11 physics-causality VFX ("shape the vapor into layered translucent sheets, geometric folds... architectural monument built from heat") + hands-only framing + Raycast `{argument}` number/title slots. Catalog stays at 40 techniques.

Sep 22 2026 cycle note (17,560 prompts): +24 prompts, +4 stars (9,928→9,932, no milestone — next: 10k). 2 new bot commits (both `[skip ci]` noise). Featured prompts unchanged (same 6). 8 entries published Sep 21 rotated into the README window — all read in full and mapped onto existing catalog, NO new technique promoted: No. 1 "GPT Image 2 Mirror Selfie Prompt" + No. 3 "Garden Dappled Light" (Prompt アトリエ｜AI画像プロンプト, JA) = the author's labeled-section formula (Subject / Main Subject / Person & Expression / Clothing & Pose / Background & Light / Composition & Camera / Texture & Style) with "Negative:" defect-guard tail — #22 folklore again; No. 2 "South Asian Woman Fashion Editorial" (Zarnish) = flat 85mm fashion-editorial portrait paragraph (author's recurring saree/editorial family); No. 4 "Cinematic Male Portrait Prompt" (Aijaz, Sep 21) = warm-amber rim / navy-background studio chiaroscuro — the author's recurring cinematic portrait family (third consecutive-day variant); No. 5 "Citrus Garden Candid Portrait" (Aqsa) = flat candid UGC paragraph with exhaustive defect-negative tail; No. 21 "Countryside Road Lifestyle Photo" (Cherry) = reference-inspired "completely original" two-friend travel scene with per-character wardrobe specs (recreation-with-divergence, existing family); No. 22 "Ethereal Twin Portrait Effect" (Derek Wen｜德里克文, ZH, Raycast-friendly) = 50/50 split-frame photo-transform — top preserves the uploaded photo, bottom generates a "Spirit Companion" manifestation with `{argument}` material menu (smoke/light/ink/data particles/petals...) — the #21 Split-Frame photo-transform family with Raycast parameterization, second consecutive-day split-frame same-scene variant; No. 83 "Heavenly Glass Platform Luxury Shot" (HeisenLegacy) = flat cinematic luxury editorial paragraph (glass platform over clouds, golden sunrise). Catalog stays at 40 techniques.

Sep 21 2026 cycle note (17,536 prompts): +4 prompts, +10 stars (9,918→9,928, no milestone — next: 10k). 2 new bot commits (both `[skip ci]` noise). Featured prompts unchanged (same 6). 2 entries published Sep 20 rotated into the README window — both read in full and mapped onto existing catalog, NO new technique promoted: No. 1 "Cinematic Male Portrait Prompt for GPT Image 2" (Aijaz, Sep 20) = reference-image face lock + luxury fashion-editorial studio portrait with cool-blue rim / warm key chiaroscuro — author's recurring family, nothing novel; No. 21 "Split-Panel Travel Poster Prompt" (Sairah, Sep 20, EN, Raycast-friendly) = vertical poster pairing photographic top panel with 3D layered paper-craft re-creation of the *same scene* below (cross-medium same-scene split — #21 Split-Frame/photo-transform family) with `{argument name=... default=...}` template fields (Raycast parameterization, already covered — the 6 featured prompts use the same syntax). Catalog stays at 40 techniques.

Sep 20 2026 cycle note (17,532 prompts): +9 prompts, +7 stars (9,911→9,918, no milestone — next: 10k). 2 new bot commits (both `[skip ci]` noise). Featured prompts unchanged (same 6). ~15 entries published Sep 18–19 rotated into the README window — all read in full and mapped onto existing catalog, NO new technique promoted: No. 1 "Playful Morning Selfie Portrait" (One Breath｜AI Portrait, Sep 19) = flat candid selfie paragraph (wink + tongue-out expression spec, sheer-curtain morning light) — standard flat-photography family; No. 21 "Cinematic Studio Portrait Prompt" (Aijaz, Sep 19) = Face Lock studio portrait ("preserving his facial identity, facial structure, hairstyle, beard, skin tone") + warm side-lighting chiaroscuro — the author's recurring cinematic portrait family; No. 2 "Seaside Sunset Dinner" + No. 6 "Bookstore Reading" (Prompt アトリエ, JA) = labeled-section formula w/ "Negative Prompt:" tail (#22 folklore); No. 4 "Realistic travel portrait" = flat travel portrait w/ defect-negative tail; No. 5 "Girl Winking Holding Miniature Bike Keychain" + No. 7 "Parisian Cafe Woman with Cat" = flat candid paragraphs w/ exact-string prop text; No. 23 "Ultra Realistic Fashion Portrait" + No. 24 "Luxury Mediterranean Fashion Editorial" + No. 26 "Cinematic Fitness Campaign Photo" = flat fashion/fitness editorial paragraphs (85mm spec, `{argument}` typography slot in No. 26); No. 25 "Hand-Drawn Fashion Illustration Transformation" = photo→illustration preservation transform (composition/pose/clothing lock + medium reassignment) — #21/#18 family, notably includes a "Short version for image models:" compressed re-prompt (single data point of dual-length authoring, noted not promoted); No. 27 "Soft-Focus Diptych of a Quiet Writing Moment" = two-panel treatment delta (#34 family, sharp vs. soft-focus panels + exact serif text strings); No. 32 "Anime Character Design Sheet: Sword Queen" = turnaround/expression-anchor character sheet (#33/#39 sheet family in prose-section layout); No. 33 "Folk Art Cafe Study Illustration" = structured flat illustration prompt (use-case/scene/style/palette sections, 60% focal-occupancy spec) — Structure B/C family; No. 48 "Giant Police Robot Capturing Bear" = flat photoreal scene w/ dense bilingual exact-string signage. Catalog stays at 40.

Sep 17 2026 cycle note (17,494 prompts): +24 prompts, +11 stars (9,891→9,902, no milestone — next: 10k). 2 new bot commits (both `[skip ci]` noise). Featured prompts unchanged (same 6). ~12 entries published Sep 16 rotated into the README window — all read in full and mapped onto existing catalog, NO new technique promoted: No. 1 "Double Exposure Mountain Dawn Portrait" (Tiyashi) = face-preserving double-exposure *edit* of a reference portrait (mountain-dawn clothing/background replacement + constellation overlay) — Face Lock edit-variant + double-exposure family (same mechanism as No. 89 below); No. 2 "Yellow Dress Mirror Selfie" + No. 4 "Black Hair Window Chair Photo" (Prompt アトリエ, JA) = labeled-section photoreal portrait formula (#22 element-scoped negatives); No. 3 "Cozy Home Portrait" (Andy) = flat candid interior portrait; No. 21 "Retro Film Photography Woman Running" (yusra.) = flat retro-film candid paragraph; No. 22 "Seaside Cafe Portrait" = flat golden-hour portrait; No. 23 "Nighttime flash peony bouquet" (Sairah) = labeled-section flash-portrait (PRESERVE 100% LIKENESS Face Lock header, per-zone motion-blur + hard-flash exposure spec, MJ-style `--ar/--raw/--style` tail flags — tail flags are Midjourney import folklore, GPT Image 2 takes aspect via API params; noted not promoted); No. 24 "Miniature Kiwi Island Resort" (Arzoo Ai) = miniature food-diorama world w/ dense readable text props (multi-sign exact-string discipline); No. 51 "Cinematic Red Smoke Movie Poster" (AiHua) = flat poster paragraph; No. 88 "Cinematic velvet suit portrait" (HeisenLegacy) = flat cinematic portrait; No. 89 "High-Fashion Editorial Double Exposure" (Aijaz) = ghosted double-exposure portrait w/ face reference + rim-light spec; No. 90 "Tiny Chefs Magical Miniature Bakery" (Mehwish kiran) = miniature food-diorama. Catalog stays at 40.

Sep 16 2026 cycle note (17,470 prompts): +17 prompts, +10 stars (9,881→9,891, no milestone — next: 10k). 2 new bot commits (both `[skip ci]` noise). Featured prompts unchanged (same 6). ~9 entries published Sep 15 rotated into the README window — all read in full and mapped onto existing catalog, NO new technique promoted: No. 1 "Realistic Professional Avatar" (小小东, ZH) = identity-locked flat avatar paragraph with asymmetric-composition negative-space framing; notable single data point: era-specific sensor emulation spec ("early digital avatar texture of 2000s–2010s", JPEG grain, black lift) — Source-Look Preservation (#21) flavor applied to generation, noted not promoted; No. 2 "Handsome Man Cinematic Portrait" (HeisenLegacy) = flat cinematic portrait (85mm/f1.8 + defect-negative tail); No. 3 "Cinematic Male Portrait Reference" (Aijaz) = flat face-reference portrait; No. 4 "Rainy Day Cafe Portrait" (Selina) = flat candid smartphone-aesthetic paragraph; No. 21 "Mirror Ballet Pointe Portrait" (Prompt アトリエ, JA) = labeled-section portrait formula w/ element-scoped negative (#22); No. 22 "Golden Hour Portrait Collage" (Laraib Fatima) = 3×3 JSON collage w/ face.preserve_original identity lock (Face Lock JSON variant); No. 23 "Luxury Fashion Portrait" (Lavinia) = flat high-fashion paragraph; No. 24 "Parisian Café Vintage Portrait" (Julia) = flat fashion paragraph; No. 25 "Fashion Magazine Scrapbook" (モヒにゃぱん, JA) = two-line identity-collage ultra-minimal (corkboard + attached-image person, Face Lock short form). Catalog stays at 40.

Sep 15 2026 cycle note (17,453 prompts): +22 prompts, +26 stars (9,855→9,881, no milestone — next: 10k). 4 new bot commits (all `[skip ci]` noise). Featured prompts unchanged (same 6). ~10 entries published Sep 13-14 rotated into the README window — all read in full and mapped onto existing catalog, NO new technique promoted: No. 1 "Green Wall Shadow Portrait" + No. 4 "Afternoon Tweed Dress Portrait" + No. 6 "Evening Street White Dress Portrait" + No. 8 "Morning Kitchen Apron Portrait" (all Prompt アトリエ, JA) = the labeled-section photoreal portrait formula (Subject/Main Subject/Person & Expression/Clothing & Pose/Background & Light/Composition & Camera/Texture & Style/Negative) with element-scoped negatives (#22 — "Do not omit the spotted blue-green wall and the single leg extended") and hard front-flash / window-light lighting specs; No. 2 "Parisian Cafe Portrait" (Julia) = flat golden-hour portrait paragraph; No. 3 "Digital Oil Painting Portrait" (Aijaz) = flat painterly portrait w/ face-reference; No. 5 "Real Person Doodle Shadow" (Sarmad Tahir) = #18 Medium-Partition Hybrid (photoreal person + hand-drawn doodle-shadow, medium-bleed ban + identity lock); No. 7 "Y2K Collage Portrait" (Eesha) = 3-panel character-consistency collage (Face Lock gen-variant); No. 21 "Mid-Autumn Typography Poster" (小小东) = bilingual CJK typography poster, exact string literals + font-pairing spec (Songti serif + light sans) — structured-typography family; No. 22 "Giant Man Above Paris" (HeisenLegacy) = forced-perspective scale illusion via extreme-foreground boot + tiny city cues; No. 23 "Retro Duotone Screen-Print Portrait" (HER19845) = flat duotone style paragraph; No. 24 "Cinematic Time-Travel City Portrait" (HeisenLegacy) = flat cinematic era-collision paragraph; No. 25 "Tehran Old City Adventure Comic" = hex-code palette constraints attached to scene regions (single data point of explicit hex color assignment, noted not promoted); No. 33 "Minimalist Ceremony Poster" (小小东, ZH) = museum-whitespace poster formula with "failure symptoms include..." clause — an interesting anti-failure spec flavor (names the failure modes of the style), single strong data point, not promoted; No. 120 "B&W Fiber-Flow Logo" (Shami) = source-mode logo material transform w/ strict palette + dense NEGATIVE list. Catalog stays at 40.

Sep 13 2026 cycle note (17,431 prompts): +12 prompts, +14 stars (9,841→9,855, no milestone — next: 10k). 1 new bot commit (`[skip ci]` noise). Featured prompts unchanged (same 6). 5 entries published Sep 12 rotated into the README window — all read in full and mapped onto existing catalog, NO new technique promoted: No. 21 "South Asian Woman in Traditional Saree" (Zarnish) = flat portrait formula with Raycast `{argument}` fill-in slots (85mm + golden hour + bokeh tail); No. 22 "Cozy Camper Van Milky Way Night" (Lavinia) = cozy-interior flat paragraph (#10 layered interior prop stacking, argument slots); No. 23 "Parisian Cafe Candid Street Photography" (Sairah) = foreground motion-blur occlusion layer over sharp subject (layered composition, single data point of the occlusion framing, noted not promoted); No. 24 "Realistic Lifestyle Photo with Doodle Wall Art" (Saira) = #18 Medium-Partition Hybrid (photoreal subjects interacting with hand-drawn doodle wall) — direct repeat of No. 24 "Anime Doodle and Real Photo Fusion"; No. 74 "Vintage Editorial Portrait Collage" (Aijaz) = 2×2 character-consistency collage (Face Lock generation-variant + multi-panel grid). Catalog stays at 40.

Sep 12 2026 cycle note (17,419 prompts): +21 prompts, +7 stars (9,834→9,841, no milestone — next: 10k). 2 new bot commits (both `[skip ci]` noise). 5 entries published Sep 11 rotated into the README window — all mapped onto existing catalog, no promotions: No. 21 "Candid car selfie in sunlight" (Aqsa) = flat photoreal selfie family (Face Lock-adjacent generation specs, HDR/lens-imperfection tail); No. 72 "Anime Train at Dusk with Mount Fuji" = cinematic anime scene, count-constrained props (exactly 3 straps, 1 door) — #5/#11 enumeration discipline in prose; No. 89 "Editorial Fashion Menswear Portrait" (Aijaz) and No. 90 "Cinematic Luxury Fashion Portrait" (HeisenLegacy) = standard editorial portrait formulas (85mm/f2.8 spec + geometric window shadows; old-money palette + negative-avoidance tail); No. 119 "Galaxy Rail Title Screen" = Goal/Canvas/Layout/Text-content structured game-asset spec — #34-structured-UI family with exact string literals for UI text. Catalog stays at 40.

Sep 11 2026 cycle note (17,398 prompts): technique #40 promoted from No. 52. Other rotated entries mapped onto existing catalog — No. 36 "Research Paper Academic Poster" (Daichi Konno, Sep 10) is a 188-char ultra-minimal *research-delegation* prompt ("Research the poster regulations for presentation at [conference] and transform the attached paper into a poster accordingly") — the delegation/inference family (#19/#27) applied to compliance research, single data point, noted not promoted; No. 88 "Venus Soap Holder" & No. 89 "Mondrian Storage Cabinet" (both Cell 细胞, Sep 10) are artwork-grounded 3-zone presentations (painting reference | pencil sketch | product-in-use) — a #34-family multi-panel consistency flavor, not novel; No. 1 "Golden Hour Sunset Side Profile Portrait" (Muhammad Jamil, Sep 10) is standard Face Lock + camera-spec depth. Stars +21 (9,813→9,834), no milestone crossed (next: 10k).
